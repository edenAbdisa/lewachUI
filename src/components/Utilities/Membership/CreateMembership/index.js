    ...
    <div className='popup'>
      ...
      <Form onSubmit={(e) => this.onSubmit(e)}> 
        <Form.Group controlId="formBasicAddMembership" onSubmit={this.onSubmit}>
            ...
            <Form.Control type="number" placeholder={this.state.isCreate?'Enter transaction limit':this.props.singleData.name} value={limitOfPost}
                onChange={this.onChange} name="limitOfPost" disabled={this.state.isDelete}/>
                <Form.Label>Limit of post</Form.Label>
            <Form.Control type="number" placeholder={this.state.isCreate?'Enter Limit of post':this.props.singleData.name} value={transactionLimit}
                onChange={this.onChange} name="transactionLimit" disabled={this.state.isDelete}/>
        </Form.Group> 
