...
render(){
    return(
        <> 
        <h3 style={{textAlign:'center', color:THEME.TitleColor, fontSize:THEME.TitleSize}}>Internal Account management</h3>

          <p 
                    onClick={this.addUserViewPopup.bind(this)}
                  >
                   <GrAdd/> Add Users
                  </p>
                  <RowSelection 
